...
self.addEventListener('fetch', function(e){
  ...
  /* Μόνο same-origin cache. Τα external (TradingView chart, Yahoo price, Claude API)
     πάνε κανονικά στο δίκτυο — offline αποτυγχάνουν σιωπηλά, ο calculator δουλεύει. */
